        ...
        <div className="min-h-screen bg-background">
            ...
            <div className="lg:pl-64 transition-all duration-300">
                ...
                <main>
                    ...
                    {/* Hero Section */}
                    {/* 간격을 넓히기 위해 py-32로 상하 여백 대폭 증가 */}
                    <section className="relative py-32 px-6 overflow-hidden bg-gradient-to-b from-background to-sky-50 dark:to-sky-900/10">
                        <div className="max-w-5xl mx-auto text-center relative z-10">
                            ...
                            <div className="flex flex-col sm:flex-row gap-5 justify-center">
                                <Button size="lg" className="h-14 px-10 text-lg font-semibold bg-gradient-to-r from-sky-500 to-teal-400 hover:opacity-90 transition-opacity shadow-lg shadow-sky-200/50 border-0" onClick={handleAction}>
                                    새 이력서 작성하기
                                </Button>
                    ...
                    <section className="py-32 px-6 bg-white dark:bg-zinc-900 border-t border-border/50">
                        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 md:gap-24 items-center">
                            ...
                            <div className="relative">
                                <div className="absolute inset-0 bg-gradient-to-tr from-sky-100 to-transparent rounded-2xl transform translate-x-6 translate-y-6 -z-10" />
                                <div className="bg-card border rounded-2xl shadow-xl p-8 aspect-[4/5] flex flex-col relative overflow-hidden">
                                    ...
                                    <div className="absolute bottom-6 right-6">
                                        <div className="flex items-center gap-2 bg-sky-500 text-white px-4 py-2 rounded-full shadow-lg">
                    ...
                    {/* CTA Section */}
                    <section className="py-32 px-6 text-center bg-sky-50 dark:bg-sky-900/10">
                        <div className="max-w-3xl mx-auto space-y-8">
                            ...
                            <Button size="lg" className="h-14 px-12 text-lg font-semibold bg-gradient-to-r from-sky-500 to-teal-400 hover:opacity-90 transition-opacity text-white border-0" onClick={handleAction}>
                                무료로 이력서 작성하기
                            </Button>
                        </div>
                    </section>
