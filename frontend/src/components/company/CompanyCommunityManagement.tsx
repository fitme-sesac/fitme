                ...
                return (
                    <div className="space-y-4">
                        <div className="flex items-center justify-between mb-6">
                            <h2 className="text-xl font-bold">작성한 글 <span className="text-[#5A639C] ml-1">{MY_POSTS.length}</span></h2>
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="w-full lg:w-60 flex-shrink-0 space-y-6">
                    ...
                    <div className="bg-gradient-to-br from-[#5A639C]/10 to-[#9B86BD]/10 rounded-2xl p-5 border border-[#5A639C]/10 text-center">
                        <h3 className="text-sm font-bold text-[#5A639C] mb-1">기업 커뮤니티 지수</h3>
                        <div className="text-3xl font-black text-gray-800 mb-2">High</div>
