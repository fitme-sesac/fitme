...
export function CommunityManagement({ onBack }: CommunityManagementProps) {
    ...
    const MENU_Items = [
        { id: "posts", label: "내가 쓴 글", icon: FileText, count: stats.postCount || posts.length },
                ...
                return (
                    <div className="space-y-4">
                        <div className="flex items-center justify-between mb-6">
                            <h2 className="text-xl font-bold">내가 쓴 글 <span className="text-sky-600 ml-1">{filteredPosts.length}</span></h2>
